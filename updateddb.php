...
<body class="bg">
	...
	<input type="button" class="but" name="Home" id="Home" onclick="window.location.href='view_problem.php'" value="Home">
<?php
...
$vi="select*from farmer_question where status!='PENDING'";
	...
	<?php 
		...
		{  ?><tr>
			...
			<td><input type="text" class="but" name="name" id="name" readonly value="<?php echo $row['sno'];?>"></td>
			...
			<td><input type="submit" name="sub" class="but" id="sub" value="<?php echo $row['status'];?>"></td>
		</tr>
	</form>
		<?php 
